...
?>
        ...
        <h1 style="padding:5px;margin-left:20px;margin-top:80px;">Статьи на сайте:</h1>
            <?php
if (isset($loggedin)){
            echo '<button type="button" onclick="teleport2()";>Добавить статью</button>';}
            ?>
             <hr class="main_line"/>
...
$result=$mysqli->query("SELECT * FROM article ORDER BY article_id DESC");
$counter=1;
